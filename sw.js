const CACHE = "alex-hq-v24";
const APP = ["./", "./index.html", "./styles.css?v=20", "./field.css?v=4", "./app.js?v=14", "./manifest.webmanifest", "./icon.svg", "./icon-180.png", "./icon-192.png", "./icon-512.png"];
