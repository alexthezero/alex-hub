const CACHE = "alex-hq-v25";
const APP = ["./", "./index.html", "./styles.css?v=20", "./field.css?v=5", "./app.js?v=15", "./manifest.webmanifest", "./icon.svg", "./icon-180.png", "./icon-192.png", "./icon-512.png"];
