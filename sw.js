const CACHE = "alex-hq-v22";
const APP = ["./", "./index.html", "./styles.css?v=20", "./field.css?v=2", "./app.js?v=13", "./manifest.webmanifest", "./icon.svg", "./icon-180.png", "./icon-192.png", "./icon-512.png"];
